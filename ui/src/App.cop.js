      ...
      <div style={{textAlign: "center"}}>
       ...
       { 
        ...
        ? <React.Fragment>
              ...
              <input type="button" value="send now" onClick={this.sendMessage} />

          </React.Fragment>
        : <p> 
            <input type="text" value={this.state.value} id="userName" placeholder="Enter your name" />
            <Button type="primary" shape="round" onClick={this.handleNameChange} >Submit <RightCircleOutlined /></Button>
